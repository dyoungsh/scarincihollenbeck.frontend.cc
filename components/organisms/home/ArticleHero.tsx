...
const ArticleHero: React.FC<Props> = ({ featuredPost, articleList }: Props) => {
  return (
    <>
      <ArticleContainer>
      ...
      <LinkContainer>
        <PageLink
          label="Read more articles about our attorneys"
...
// export default function ArticleHero({ feature }) {
