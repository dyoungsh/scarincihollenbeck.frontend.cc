import { extractDescription, extractFeaturedImage, formatDate } from 'utils/helpers'
...
export const getAuthorContent = async (slug) => {
  ...
  const firstFourPostsFromAuthorQuery =
    "SELECT ID, post_date, post_content, post_title, post_name FROM sh_db_prod.wp_posts WHERE post_author = ? AND post_status = 'publish' ORDER BY post_date DESC LIMIT 4;"
